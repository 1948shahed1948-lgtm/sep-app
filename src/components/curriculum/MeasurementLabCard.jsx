...
export default function MeasurementLabCard() {
  ...
  return (
    ...
    >
      ...
      <div className="relative grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
        ...
        <div className="lg:col-span-3 space-y-5">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/20">
            ...
            <span className="text-xs font-bold text-amber-700">
              {lang === 'ar' ? 'مخبر القياس' : 'Measurement Lab'}
            </span>
          </div>
          ...
          <p className="text-sm sm:text-base text-slate-600 leading-relaxed">
            {lang === 'ar'
              ? 'بنك أسئلة مدمج داخل منصتنا يضم أسئلة مرتبة بدقة وفق المنهج السعودي لجميع الصفوف. يقدّم كل سؤال شرحاً تفصيلياً وخطوات حل على السبورة، إضافة إلى القاعدة الذهبية وسؤال تغذية راجعة يعزّز الفهم ويثبّت المعلومة. مثالي للتدريب الذاتي واكتشاف الفجوات المهارية قبل الاختبارات.'
              : 'An integrated question bank within our platform hosting questions precisely organized along the Saudi curriculum for every grade. Each question offers a detailed explanation, blackboard solution steps, a golden rule, and a feedback question that deepens understanding. Ideal for self-practice and identifying skill gaps before exams.'}
          </p>
        ...
        {/* Action card — internal link to question bank */}
            ...
            <div className="relative space-y-5">
              ...
              <div className="space-y-1.5">
                <h3 className="text-xl font-heading font-bold">
                  {lang === 'ar' ? 'ابدأ التدريب الآن' : 'Start Practice Now'}
                </h3>
                <p className="text-xs text-white/60">
                  {lang === 'ar' ? 'بنك الأسئلة المدمج — بدون خروج من المنصة' : 'Integrated bank — no leaving the platform'}
                </p>
              </div>

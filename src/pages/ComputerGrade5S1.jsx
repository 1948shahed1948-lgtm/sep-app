...
import { COMPUTER_G5_S1_UNITS, COMPUTER_G5_S1_TOTAL } from '@/lib/computerGrade5S1Bank';
...
export default function ComputerGrade5S1() {
  const { isRTL } = useLang();
  ...
  if (done && activeLesson) {
    ...
    return (
      <div className="space-y-6">
        <PageHeader title="الحاسب الآلي — الصف الخامس ف١" backTo="/question-bank/grade_5/first" />
  ...
  if (activeLesson && q) {
    ...
    return (
      <div className="space-y-4">
        <PageHeader title="الحاسب الآلي — الصف الخامس ف١" subtitle={activeLesson.title_ar} backTo="/question-bank/grade_5/first" />
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="الحاسب الآلي — الصف الخامس الابتدائي (ف١)"
        subtitle={`${COMPUTER_G5_S1_TOTAL} سؤالاً موزعةً على ${COMPUTER_G5_S1_UNITS.length} وحدات`}
      ...
      <div className="max-w-4xl mx-auto px-4 space-y-6">
        <div className="grid grid-cols-3 gap-3">
          {[
            { n: toAr(COMPUTER_G5_S1_UNITS.length), l: 'وحدة' },
            { n: toAr(COMPUTER_G5_S1_UNITS.reduce((s, u) => s + u.lessons.length, 0)), l: 'درسًا' },
            { n: toAr(COMPUTER_G5_S1_TOTAL), l: 'سؤالًا' },
          ].map((s) => (
        ...
        {COMPUTER_G5_S1_UNITS.map((unit, ui) => (

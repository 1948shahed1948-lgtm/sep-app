...
import { COMPUTER_G6_S2_UNITS, COMPUTER_G6_S2_TOTAL } from '@/lib/computerGrade6S2Bank';
...
export default function ComputerGrade6S2() {
  const { isRTL } = useLang();
  ...
  if (done && activeLesson) {
    ...
    return (
      <div className="space-y-6">
        <PageHeader title="المهارات الرقمية — الصف السادس ف٢" backTo="/question-bank/grade_6/second" />
  ...
  if (activeLesson && q) {
    ...
    return (
      <div className="space-y-4">
        <PageHeader title="المهارات الرقمية — الصف السادس ف٢" subtitle={activeLesson.title_ar} backTo="/question-bank/grade_6/second" />
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="المهارات الرقمية — الصف السادس الابتدائي (ف٢)"
        subtitle={`${COMPUTER_G6_S2_TOTAL} سؤالاً موزعةً على وحدتين`}
        ...
        breadcrumbs={[
          ...
          { label: 'الفصل الثاني', path: '/question-bank/grade_6/second' },
      ...
      <div className="max-w-4xl mx-auto px-4 space-y-6">
        <div className="grid grid-cols-3 gap-3">
          {[
            { n: toAr(COMPUTER_G6_S2_UNITS.length), l: 'وحدة' },
            { n: toAr(COMPUTER_G6_S2_UNITS.reduce((s, u) => s + u.lessons.length, 0)), l: 'درسًا' },
            { n: toAr(COMPUTER_G6_S2_TOTAL), l: 'سؤالًا' },
          ].map((s) => (

...
import { ENGLISH_G6_S2_UNITS, ENGLISH_G6_S2_TOTAL } from '@/lib/englishGrade6S2Bank';
...
// ─── Main Page ───────────────────────────────────────────────
export default function EnglishGrade6S2() {
  ...
  const unit = active ? ENGLISH_G6_S2_UNITS[active.unitIdx] : null;
    ...
    return (
      <div className="space-y-6">
        <PageHeader
          ...
          breadcrumbs={[
            { label: t('home'), path: '/' },
            { label: 'English — Grade 6', path: '/english-grade6-s2' },
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <div className="flex items-center gap-2 pb-2 border-b border-slate-100">
                ...
                <span className="text-xs text-slate-400">English — Grade 6 — Semester 2</span>
              </div>
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        subtitle={`${ENGLISH_G6_S2_UNITS.length} Units · ${ENGLISH_G6_S2_TOTAL} Questions — Past Tense · Future Plans · Health · Travel`}
        breadcrumbs={[{ label: t('home'), path: '/' }, { label: 'English — Grade 6' }]}
      />

      <div className="max-w-4xl mx-auto px-4 space-y-6">
        <div className="grid grid-cols-3 gap-3">
          {[
            { n: ENGLISH_G6_S2_UNITS.length, l: 'Units' },
            { n: ENGLISH_G6_S2_UNITS.reduce((s, u) => s + u.lessons.length, 0), l: 'Lessons' },
            { n: ENGLISH_G6_S2_TOTAL, l: 'Questions' },
          ].map((s) => (
        ...
        {ENGLISH_G6_S2_UNITS.map((unit, ui) => (
